...
# 3. Helper function to get the average vector of a sentence
...
def query_point_creator(q1,q2,model):
    ...
    #  Get sentence vectors for question1 and question2
    q1_w2v = np.array([sentence_vector(q1, w2v_model, 100) ])
    q2_w2v = np.array([sentence_vector(q2, w2v_model, 100) ])
